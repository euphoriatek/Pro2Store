const p2s_country_form = {
    ...
    methods: {
        ...
        async saveItem() {
            ...
            const request = await fetch(this.base_url + "index.php?option=com_ajax&plugin=protostore_ajaxhelper&method=post&task=task&type=country.save&format=raw", {
                method: 'POST',
                mode: 'cors',
                cache: 'no-cache',
            ...
            if (response.success) {
                ...
                if (this.andClose) {
                    ...
                    window.location.href = this.base_url + 'index.php?option=com_protostore&view=countries';
                } else {
