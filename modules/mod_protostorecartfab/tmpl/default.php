...
<div id="<?= $id; ?>">
    <div class="uk-hidden@m">
        <div class="uk-position-fixed uk-position-<?= $params->get('position'); ?>-<?= $params->get('side'); ?> uk-margin-small-<?= $params->get('position') === 'bottom' ? 'bottom' : 'top'; ?> uk-margin-small-<?= $params->get('side') === 'left' ? 'left' : 'right'; ?>"
             style="z-index: 1000">

            <a href="<?= $checkoutLink; ?>"
               class="uk-icon-button uk-button-<?= $params->get('button_type'); ?> uk-margin-small-right"
               style="width: <?= $params->get('size'); ?>px; height: <?= $params->get('size'); ?>px">
                <span id="yps_cart_fab_icon" uk-icon="icon: cart"></span>
                {{count}}
            </a>
