...
$document->addStyleSheet($rootUrl . "media/com_protostore/css/style.css");
$document->addStyleSheet($rootUrl . "media/com_protostore/js/angular/{{styles}}");
...
// version
$xml = simplexml_load_file(JPATH_ADMINISTRATOR . "/components/com_protostore/protostore.xml");
...
<script src="<?= $rootUrl; ?>media/com_protostore/js/angular/{{runtime-es2015}}"
        type="module"></script>
<script src="<?= $rootUrl; ?>media/com_protostore/js/angular/{{runtime-es5}}" nomodule
        defer></script>
<script src="<?= $rootUrl; ?>media/com_protostore/js/angular/{{polyfills-es5}}" nomodule
        defer></script>
<script src="<?= $rootUrl; ?>media/com_protostore/js/angular/{{polyfills-es2015}}"
        type="module"></script>
<script src="<?= $rootUrl; ?>media/com_protostore/js/angular/{{main-es2015}}"
        type="module"></script>
<script src="<?= $rootUrl; ?>media/com_protostore/js/angular/{{main-es5}}" nomodule defer></script>
