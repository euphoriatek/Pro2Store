...
class JFormFieldDiscount extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '<span v-if="form.jform_discount_type == 1">';
		...
		$html[] = '</p-inputnumber>';
		$html[] = '</span>';
		$html[] = '<span v-if="form.jform_discount_type == 2">';
		...
		$html[] = '<option selected value="1">'.Text::_('COM_PROTOSTORE_ADD_PRODUCT_PRODUCT_OPTION_MODIFIER_TYPE_AMOUNT').'</option>';
		$html[] = '<option value="2">'.Text::_('COM_PROTOSTORE_ADD_PRODUCT_PRODUCT_OPTION_MODIFIER_TYPE_PERCENT').'</option>';
		$html[] = '</select>';
		$html[] = '</div>';
		$html[] = '</div>';
