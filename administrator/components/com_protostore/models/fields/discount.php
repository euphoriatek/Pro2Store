...
class JFormFieldDiscount extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '<option :selected="form.jform_discount_type == \'amount\'" value="amount">' . Text::_('COM_PROTOSTORE_ADD_PRODUCT_PRODUCT_OPTION_MODIFIER_TYPE_AMOUNT') . '</option>';
		$html[] = '<option :selected="form.jform_discount_type == \'perc\'" value="perc">' . Text::_('COM_PROTOSTORE_ADD_PRODUCT_PRODUCT_OPTION_MODIFIER_TYPE_PERCENT') . '</option>';
		$html[] = '</select>';
		$html[] = '</div>';
		$html[] = '</div>';
