                        ...
                        <div class="uk-grid uk-grid-small">
                            <div class="uk-width-expand">
                                <h3>
									...
									<?= Text::_('COM_PROTOSTORE_EMAILMANAGER_TITLE'); ?>
                                </h3>
                            </div>
                    ...
                    <div class="uk-card-body">
                        ...
                        <table class="uk-table uk-table-striped uk-table-divider uk-table-hover uk-table-responsive  uk-table-middle">
                            ...
                            <tr>
                                ...
                                <th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_EMAILMANAGER_TABLE_EMAIL_TYPE'); ?>
                                    <a href="#" @click="sort('type')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_EMAILMANAGER_TABLE_EMAIL_LANGUAGE'); ?>
                            ...
                            <tr class="el-item" v-for="item in itemsChunked[currentPage]">
                                ...
                                <td class="uk-text-center">
                                    <span v-show="item.language == '*'">{{item.language}}</span>
                                    <img v-show="item.language_image != '*'"
                                         :src="'../media/mod_languages/images/' + item.language_image + '.gif'">
