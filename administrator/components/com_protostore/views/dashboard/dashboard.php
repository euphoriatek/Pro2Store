...
<div class="uk-grid" uk-grid>
            ...
            <div class="uk-card-header">
                <div class="uk-grid uk-grid-small">
                    <div class="uk-width-auto">
                        <h4><?= Text::_('COM_PROTOSTORE_LATEST_ORDERS'); ?>
                    ...
                    <div class="uk-width-expand uk-text-right panel-icons"><a
                                routerlink="/orders" title="" data-uk-tooltip=""
                                data-uk-icon="icon: arrow-right" aria-expanded="false" class="uk-icon-link uk-icon"
                                href="/administrator/index.php/orders">See All
                ...
                <div>
                    <table id="orderList"
                        ...
                        <tr>
                            <td>
                                <div class="name"><a
                                                                           href="/administrator/index.php/order/482">DJNIH54425</a>
                                </div>
                            </td>
                            <td><a uk-toggle=""
                            ...
                            <td> Ray Lawlor</td>
                            <td><span
                                                            class="uk-label uk-label-p">Pending</span></td>
    ...
    <div class="uk-width-1-2@l uk-first-column">
      ...
      <?php  $p2s_top_right = ModuleHelper::getModules('p2s_top_right'); ?>

        <?php foreach ($p2s_top_right as $module) : ?>
