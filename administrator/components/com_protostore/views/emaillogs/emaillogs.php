						...
						<div class="uk-grid uk-grid-small">
							<div class="uk-width-expand">
								<h3>
									...
									<?= Text::_('COM_PROTOSTORE_EMAILLOGS_TITLE'); ?>
								</h3>
							</div>
					...
					<div class="uk-card-body">
						...
						<table class="uk-table uk-table-striped uk-table-divider uk-table-hover uk-table-responsive  uk-table-middle">
							...
							<tr>
								...
								<th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_EMAILLOGS_TABLE_ID'); ?>
									<a href="#" @click="sort('id')" class="uk-margin-small-right uk-icon"
									   uk-icon="triangle-down">
									</a>
								</th>
								<th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_EMAILLOGS_TABLE_ADDRESS'); ?>
									<a href="#" @click="sort('emailaddress')" class="uk-margin-small-right uk-icon"
									   uk-icon="triangle-down">
									</a>
								</th>

								<th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_EMAILLOGS_TABLE_EMAIL_TYPE'); ?>
									<a href="#" @click="sort('emailtype')" class="uk-margin-small-right uk-icon"
									   uk-icon="triangle-down">
									</a>
								</th>
								<th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_EMAILLOGS_TABLE_DATE_SENT'); ?>
									<a href="#" @click="sort('sentdate')" class="uk-margin-small-right uk-icon"
									   uk-icon="triangle-down">
									</a>
								</th>
								<th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_EMAILLOGS_TABLE_CUSTOMER'); ?>
									<a href="#" @click="sort('customerid')" class="uk-margin-small-right uk-icon"
									   uk-icon="triangle-down">
									</a>
								</th>
								<th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_EMAILLOGS_TABLE_ORDER_NUMBER'); ?>
							...
							<tr class="el-item" v-for="item in itemsChunked[currentPage]">
								...
								<td>
                                    <a :href="'index.php?option=com_protostore&view=customer&id=' + item.customer_id">{{item.customer_name}}</a>
								</td>
								<td>
                                    <a :href="'index.php?option=com_protostore&view=order&id=' + item.order_id">{{item.order_number}}</a>
								</td>
								<td >
