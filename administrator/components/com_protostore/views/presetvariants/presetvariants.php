						...
						<div class="uk-grid uk-grid-small">
							<div class="uk-width-expand">
								<h3>
									...
									<?= Text::_('COM_PROTOSTORE_PRESET_VARIANTS'); ?>
								</h3>
							</div>
					...
					<div class="uk-card-body">
						...
						<table v-show="itemsChunked.length > 0"
							...
							<tr>
								...
								<th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_PRESET_VARIANTS_NAME'); ?>
									<a href="#" @click="sort('name')" class="uk-margin-small-right uk-icon"
									   uk-icon="triangle-down">
									</a>
								</th>
								<th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_PRESET_VARIANTS_ITEMS'); ?>
							...
							<tr v-for="item in itemsChunked[currentPage]">
								...
								<td>
									<a :href="'index.php?option=com_protostore&view=order&id=' + order.id">{{item.name}}</a>
								</td>
								<td>
									{{item.items}}
								</td>
