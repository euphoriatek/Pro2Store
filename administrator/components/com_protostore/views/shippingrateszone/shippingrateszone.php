...
<div id="p2s_shippingrateszone" v-cloak>
                        ...
                        <div class="uk-grid uk-grid-small">
                            <div class="uk-width-expand">
                                <h3>
									...
									<?= Text::_('COM_PROTOSTORE_ZONESHIPPINGRATES_TITLE'); ?>
                                </h3>
                            </div>
                                ...
                                <div class="uk-grid uk-grid-small " uk-grid="">
                                    <div class="uk-width-auto">
                                        <select class="uk-select" v-model="selectedZone" @change="filter">
                                            <option value="0">
				                                <?= Text::_('COM_PROTOSTORE_ADD_SHIPPING_RATE_MODAL_ZONE_SELECT_DEFAULT'); ?>
                    ...
                    <div class="uk-card-body">
                        ...
                        <table class="uk-table uk-table-striped uk-table-divider uk-table-hover uk-table-responsive  uk-table-middle">
                            ...
                            <tr>
                                ...
                                <th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_ZONESHIPPINGRATES_TABLE_ZONENAME'); ?>
                                    <a href="#" @click="sort('country_name')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_ZONESHIPPINGRATES_TABLE_WEIGHT_FROM'); ?>
                                    <a href="#" @click="sort('weight_from')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>

                                <th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_ZONESHIPPINGRATES_TABLE_WEIGHT_TO'); ?>
                                    <a href="#" @click="sort('weight_to')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_ZONESHIPPINGRATES_TABLE_COST'); ?>
                                    <a href="#" @click="sort('cost')" class="uk-margin-small-right uk-icon"
                                       uk-icon="triangle-down">
                                    </a>
                                </th>
                                <th class="uk-text-left"><?= Text::_('COM_PROTOSTORE_ZONESHIPPINGRATES_TABLE_HANDLING_COST'); ?>
                            ...
                            <template v-for="item in itemsChunked[currentPage]">
                                ...
                                <tr v-show="item.showEdit">
                                    ...
                                    <!--									</td>-->
                                    <!--									<td>-->
                                    <!--										<select v-model="item.country_id">-->
