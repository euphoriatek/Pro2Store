	...
	<ul
		...
		<li class="uk-parent">
			...
			<ul class="uk-nav-sub" hidden="">
				...
				<li>
					<a href="index.php?option=com_protostore&view=addproduct"><?= Text::_('COM_PROTOSTORE_SIDEMENU_PRODUCT_OPTIONS'); ?></a>
				</li>
		...
		<li class="uk-parent">
			...
			<ul class="uk-nav-sub" hidden="">
				<li>
					<a href="index.php?option=com_protostore&view=emailadd"><?= Text::_('COM_PROTOSTORE_SIDEMENU_ADD_EMAIL'); ?></a>
				</li>
				<li>
