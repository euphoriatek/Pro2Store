...
<div class="uk-card uk-card-<?= $data['cardStyle']; ?> uk-margin-bottom">
    ...
    <div class="uk-card-body">
        <div class="uk-grid uk-child-width-1-2@m uk-grid-match uk-grid-small" uk-grid>


            <div v-for="address in form.jform_addresses">
                <div class="uk-card uk-card-default">
                    ...
                    <div class="uk-card-body" v-show="address.edit">
                        ...
                        <label for="address_town" class="uk-form-label">Town</label>
                        <div class="uk-form-controls">
