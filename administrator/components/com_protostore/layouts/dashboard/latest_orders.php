    ...
    <div class="uk-card-header">
        ...
        <div class="uk-grid" uk-grid="">
            <div class="uk-width-expand">
                <h4><?= Text::_('COM_PROTOSTORE_LATEST_ORDERS'); ?> &nbsp; <i class="fad fa-box-check"></i>
                </h4>
    ...
    <div class="uk-card-body">
        <table class="uk-table uk-table-striped uk-table-hover uk-table-responsive" id="orderList">
            ...
            <tr>
                ...
                <th> <?= Text::_('COM_PROTOSTORE_ORDER_NOTES'); ?></th>
                <th> <?= Text::_('COM_PROTOSTORE_CUSTOMER'); ?></th>
                <th> <?= Text::_('COM_PROTOSTORE_ORDER_STATUS'); ?></th>
                <th> <?= Text::_('COM_PROTOSTORE_ORDER_DATE'); ?></th>
                <th> <?= Text::_('COM_PROTOSTORE_ORDER_TOTAL'); ?></th>
            </tr>
            </thead>
            <tbody [hidden]="orderloading" class="uk-animation-fade">
			<?php if ($data['orders']) : ?>
				<?php
				/** @var Order $order */
				/** @var array $vars */
                                ...
                                <div id="notesmodal<?= $order->id; ?>" uk-modal>
                                    <div class="uk-modal-dialog">
                                        ...
                                        <div class="uk-modal-header">
                                            <h4><?= Text::sprintf('COM_PROTOSTORE_CUSTOMERNOTES_MODAL_TITLE', $order->order_number); ?></h4>
                                        </div>
                                            ...
                                            <div class="uk-grid" uk-grid="">
                                                ...
                                                <div class="uk-width-auto">
                                                    <button class="uk-button uk-button-default uk-button-small uk-modal-close"
                                                            type="button"><?= Text::_('COM_PROTOSTORE_MODAL_CLOSE'); ?></button>
