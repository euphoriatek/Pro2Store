                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <select class="uk-select" v-model="file_for_edit.stability_level">
                                <option value="1"><?= Text::_('COM_PROTOSTORE_FILE_STABILITY_TYPE_ALPHA'); ?></option>
                                <option value="2"><?= Text::_('COM_PROTOSTORE_FILE_STABILITY_TYPE_BETA'); ?></option>
                                <option value="3"><?= Text::_('COM_PROTOSTORE_FILE_STABILITY_TYPE_RELEASE_CANDIDATE'); ?></option>
                                <option value="4"><?= Text::_('COM_PROTOSTORE_FILE_STABILITY_TYPE_RELEASE_STABLE'); ?></option>
                            </select>
                        </div>
                    </div>
