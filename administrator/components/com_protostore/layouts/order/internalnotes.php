        ...
        <div class="uk-grid uk-grid-small">
            ...
            <div class="uk-width-auto">
                <a href="#addnotemodal" uk-toggle
                   class="uk-button uk-button-small uk-button-primary"><?= Text::_('COM_PROTOSTORE_ORDER_NEW_INTERNAL_NOTE'); ?></a>
            </div>
...
<div id="addnotemodal" uk-modal>
    <div class="uk-modal-dialog uk-modal-body">
        <h2 class="uk-modal-title"><?= Text::_('COM_PROTOSTORE_ORDER_NEW_INTERNAL_NOTE'); ?></h2>
        ...
        <p class="uk-text-right">
            ...
            <button class="uk-button uk-button-primary uk-margin-left" type="button"
                    @click="saveNote()"><?= Text::_('COM_PROTOSTORE_ORDER_BUTTON_SAVE'); ?>
            </button>
        </p>
    </div>
</div>
