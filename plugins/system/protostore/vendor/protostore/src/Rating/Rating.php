...
class Rating
{
    ...
    private function create()
    {
        ...
        $this->db->insertObject('#__protostore_rating', $object);
...
//    SETTERS
    ...
    public function save()
    {
        ...
        $result = $this->db->updateObject('#__protostore_rating', $this, 'id');
    ...
    public static function getAverageRating($itemId)
    {
        ...
        $query->from($db->quoteName('#__protostore_rating'));
