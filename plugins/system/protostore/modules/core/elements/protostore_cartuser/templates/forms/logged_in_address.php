...
<div class="uk-card uk-card-body uk-card-default uk-margin">
	...
	<form class="uk-margin-bottom" @submit.prevent="submitAddressForm">
		...
		<div class="uk-margin">
			...
			<div class="uk-form-controls">
				<input class="uk-input" id="yps_cart_name" type="text"
				       ...
				       required name="name" v-model="address.name">
			</div>
		</div>
		...
		<?php if ($config->get('address_show', 1)): ?>
			...
			<div class="uk-margin">
				...
				<div class="uk-form-controls">
					<select class="uk-select" id="yps_cart_zone" name="zone" v-model="address.zone"
