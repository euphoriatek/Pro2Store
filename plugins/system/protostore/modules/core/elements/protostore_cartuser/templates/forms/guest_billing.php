...
<div v-cloak v-show="!billing_address">
	...
	<form class="uk-margin-bottom" @submit.prevent="newguestbillingSubmit">
		...
		<div class="uk-margin">
			...
			<div class="uk-form-controls">
				<input class="uk-input" id="yps_cart_name" type="text"
				       ...
				       required name="name" v-model="billing_address_form.name">
			</div>
		</div>
		...
		<?php if ($config->get('address_show', 1)): ?>
			...
			<div class="uk-margin">
				...
				<div class="uk-form-controls">
					<input class="uk-input" id="yps_cart_address1" type="text" required name="address1"
					       ...
					       v-model="billing_address_form.address1">
				</div>
			</div>
				...
				<div class="uk-margin">
					...
					<div class="uk-form-controls">
						<input class="uk-input" id="yps_cart_address2" type="text" name="address2"
						       ...
						       v-model="billing_address_form.address2">
					</div>
				</div>
			<?php endif; ?>
				...
				<div class="uk-margin">
					...
					<div class="uk-form-controls">
						<input class="uk-input" id="yps_cart_address3" type="text" name="address3"
						       ...
						       v-model="billing_address_form.address3">
					</div>
				</div>
				...
				<div class="uk-margin">
					...
					<div class="uk-form-controls">
						<input class="uk-input" id="yps_cart_town"
						       ...
						       v-model="billing_address_form.town">
					</div>
				</div>
			<?php endif; ?>
				...
				<div class="uk-margin">
					...
					<div class="uk-form-controls">
						<input class="uk-input" id="yps_cart_postcode" type="text" name="postcode"
						       ...
						       v-model="billing_address_form.postcode">
					</div>
				</div>
			<?php endif; ?>
			<div class="uk-margin">
			...
			<div class="uk-margin">
				...
				<div class="uk-form-controls">
					<select class="uk-select" id="yps_cart_zone" name="zone" v-model="billing_address_form.zone"
			...
			<div class="uk-margin">
				...
				<div class="uk-form-controls">
					<input class="uk-input" id="yps_cart_mobile" type="text" name="mobilephone"
					       ...
					       v-model="billing_address_form.mobilephone">
				</div>
			</div>
		<?php endif; ?>
			...
			<div class="uk-margin">
				...
				<div class="uk-form-controls">
					<input class="uk-input" id="yps_cart_phone" type="text" name="phone"
					       ...
					       v-model="billing_address_form.phone">
				</div>
			</div>
		<?php endif; ?>
			...
			<div class="uk-margin">
				...
				<div class="uk-form-controls">
					<input class="uk-input" id="yps_cart_email" type="email" name="email"
					       ...
					       v-model="billing_address_form.email">
				</div>
			</div>
		<?php endif; ?>
		<div class="uk-grid">
